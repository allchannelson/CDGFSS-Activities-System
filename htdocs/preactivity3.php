          ...
          <div class="panel-body ng-scope">
            ...
            <ul dnd-list="List" class="ng-scope">
              ...
              <li class="ng-binding ng-scope"
                ng-repeat="classroom in List"
                dnd-draggable="classroom"
                dnd-effect-allowed="move"
                dnd-moved="List.splice($index, 1)"
                dnd-selected="models.selected = classroom"
                ng-class="{'selected': models.selected === classroom}"
                >
                  <div class="container-element box box-blue">
                    <h3>Class: {{classroom.class}}</h3>
                    <div class="column ng-scope" ng-repeat="item in classroom.students">
                      <div class="item ng-binding ng-scope">Student {{item.name}}</div>
                    </div>
...
angular.module("myApp").controller("SimpleDemoController", function($scope) {
  ...
  $scope.models = {
    ...
    "Test": [{
      class: "S1A",
      show: false,
      students: [{name: "Mr. Chan"},{name: "Mr. Bunny"}]
    }]
    }
  };
